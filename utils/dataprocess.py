...
if __name__ == '__main__':
    ...
    # file_path=r'D:\博士期间相关资料\理论知识相关\知识图谱\知识图谱源码\ChineseNERAnno\data\example.ann'
    # _train_test_split(file_path,test_size=0.1)
    # ------------------------------将anno转化为实体
    # path=r'D:\博士期间相关资料\理论知识相关\知识图谱\知识图谱源码\ChineseNERAnno\data\example.ann'
    ...
    #----------------将X  B-PET形式转为纯文本形式
    # path = r'D:\博士期间相关资料\理论知识相关\知识图谱\知识图谱源码\ChineseNERAnno\data\example.ann.train'
    # save_path = r'D:\博士期间相关资料\理论知识相关\知识图谱\知识图谱源码\ChineseNERAnno\data\example.ann.test.train'
    ...
    #
    # with open(r'D:\博士期间相关资料\理论知识相关\知识图谱\知识图谱源码\ChineseNERAnno\data\example.ann.test.train','r',encoding='utf-8') as f:
    #
    #     lines=f.readlines()
    ...
    path=r'C:\ChineseNERAnno\data\train_test_total.txt.ann.shot.ann.train.pure'
    with open(path,'r',encoding='utf-8') as f:
        lines=f.readlines()
    max_len=0
